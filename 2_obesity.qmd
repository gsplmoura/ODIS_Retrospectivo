...
Aqui eu defino a trajetória pós-meta: para quem atingiu ≥5%, guardo todas as observações da data da meta em diante e calculo o tempo desde a meta em semanas/meses. Também crio indicadores lógicos úteis: maint_ge5 (mantém ≥5%) e below5 (caiu abaixo de 5%).
...
Se quiser, eu preparo:
	1.	uma tabela única consolidando essas métricas,
	2.	e um parágrafo de resultados já redigido (com placeholders para números) para colar no artigo.
...
O gráfico apresenta, entre os que atingiram ≥5%, a proporção que o fez até 6 meses, entre 6–12 meses ou após 12 meses, com IC95% por categoria. Isso responde diretamente “em que janela os respondedores tendem a atingir a meta”.
